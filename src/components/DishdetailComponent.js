                ...
                <ModalBody>
                    <LocalForm onSubmit={(values)=>{this.handleSubmit(values)}}>
                        ...
                        <Row className="form-group m-1 mt-3">
                            ...
                            <Control.text className="form-control" model=".author" name="author" id="author" placeholder="Your Name" validators={{required, minLength: minLength(3), maxLength: maxLength(15)}}/>
    ...
    if(comments!=null){
        ...
        return (
            <div className = "col-12 col-md-5 m-1">
                <h4>Comments</h4>
                <ul className="list-unstyled"><Stagger in>{DishComments}</Stagger></ul>
        ...
        return (
            <div className="container">
                ...
                <div className="row">
                    ...
                    postComment={props.postComment} dishId={props.dish.id} />: null } 
                </div>
            </div>
        );
    }else{
